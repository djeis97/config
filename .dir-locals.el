  ...
  (eval .
        (progn
          ...
          (add-to-list 'geiser-guile-load-path
                       (concat (project-root (project-current)) "guixlib/"))
          (add-to-list 'geiser-guile-load-path
                       (expand-file-name "~/.config/guix/current/share/guile/site/3.0/"))
          (put 'use-package 'scheme-indent-function 1)
          (put 'emacs-config-service 'scheme-indent-function 1)
          (put 'prologue 'scheme-indent-function 0)
          (put 'epilogue 'scheme-indent-function 0)))
